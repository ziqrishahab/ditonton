      ...
      body: BlocBuilder<MovieDetailBloc, MovieDetailState>(
        builder: (context, state) {
          if (state is MovieDetailLoading) {
            ...
            return SafeArea(child: DetailContent(movie, state.recommendations));
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<WatchlistMovieBloc, WatchlistMovieState>(
      listenWhen: (previous, current) =>
          current is WatchlistMovieSuccess || current is WatchlistMovieError,
                            ...
                            children: [
                              ...
                              >(
                                buildWhen: (previous, current) =>
                                    current is WatchlistMovieStatusLoaded,
                                builder: (context, state) {
                                  final isAddedWatchlist =
                                      state is WatchlistMovieStatusLoaded
